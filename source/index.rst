...
.. raw:: html
    ...
    <div class="text-center">
        <a href="http://sourceforge.net/projects/mpc-hc/files/MPC%20HomeCinema%20-%20Win32/MPC-HC_v1.7.1_x86/MPC-HC.1.7.1.x86.exe/download"
            class="btn btn-default btn-lg sourceforge_accelerator_link">
            <i class="fa fa-download pull-left"></i>MPC-HC - Download now!
        </a>
        <p>1.7.1 32-bit - <a href="/downloads/">Other systems &amp; versions</a></p>
    </div>
